//Задена е двојно поврзана листа од двојно поврзани листи. Да се најде сума на секоја од подлистите, а потоа производ на овие суми
//
//        Влез:
//
...
public class ListaOdListi {
    ...
    public static long findMagicNumber(DLL<DLL<Integer>> list) {
        ...
        DLLNode<DLL<Integer>>listi=list.getFirst();
        while(listi!=null){
            DLLNode<Integer>red=listi.element.getFirst();
            while(red!=null){
                zbir+=red.element;
                red=red.succ;
            }
